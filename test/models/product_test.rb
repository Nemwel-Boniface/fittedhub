...
class ProductTest < ActiveSupport::TestCase
  ...
  test "Product price must be a positive integer" do
    product = Product.new(title: "My book title", description: "This is a description", image_url: "image.jpg")
  ...
  test "Whether image URL is valid or invalid" do
